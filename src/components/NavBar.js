                ...
                <Router>
                    <AppBar position = "sticky" style = {{backgroundColor:"#212121"}}>
                        ...
                        <IconButton href = "/home">
                            <LibraryBooksTwoToneIcon fontSize = "large" style={{color:"white"}}>  </LibraryBooksTwoToneIcon>
                             <p style={{color:"white"}}>Book Store</p> 
                        </IconButton>
                        </Tooltip>
                        </Grid>
                        <Grid item xs={2}>
                             {localStorage.getItem('role') == "ROLE_ADMIN"? (
                                 <>
                                  ...
                                  <Typography style = {{marginTop:"5"}}>
                                      <Button variant="outlined" color="white" href = "/admin" style = {{width:"100%",color:"white"}}>
                                          Admin Pannel
                                      </Button>
                                  </Typography>
                                </>
                        ...
                        {!localStorage.getItem('user') ? (
                            ...
                            <Grid item xs={1}>
                                <br/>
                                <Typography style = {{marginTop:"5"}}>
                                    <Button variant="outlined" color="white" href = "/login" style = {{width:"100%",color:"white"}}>
                                        Login
                                    </Button>
                                </Typography>
                            </Grid>
                            <Grid item xs={1}>
                                <br/>
                                <Typography>
                                    <Button variant="outlined" color="white" href = "/signup" style = {{width:"100%",color:"white"}}>
                                        Signup
                                    </Button>
                                </Typography>
                            </Grid></>):
                            (<>
                                ...
                                >
                                    ...
                                    <MenuItem onClick={this.handleClose}> <Button href = "/addbook">Add a Book</Button></MenuItem>
